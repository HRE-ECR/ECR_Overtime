    ...
    <div>
      ...
      <div className="mt-5 rounded-3xl bg-slate-900/60 border border-slate-800 shadow-card p-5">
        ...
        <div className="mt-6 border-t border-slate-800 pt-5">
          ...
          <button disabled={loading || !selectedId} onClick={saveStaffing}
            className="mt-3 px-4 py-3 rounded-2xl bg-emerald-500/20 border border-emerald-500/30 text-emerald-100 font-extrabold disabled:opacity-60">Save team & band</button>
        </div>
